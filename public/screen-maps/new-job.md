...
| `last_verified` | 2026-06-01 · Phase 1 F2/F2b/F3; TZ feature COMPLETE (1/3 backend, 2/3 web, 3/3 Android) + display follow-up: Jobs LIST rows on both platforms + both Joby job_assigned auto-messages (tech New Job Alert + customer Booking Confirmation) now render job-zone time. All read surfaces + all three job_assigned auto-messages show the job's zone with a label. |
