...
- **end_state:** Actor report screen (Pay Statement for tech/roster, Source Settlement for source) — REPORT BALANCE headline + compensation/settlement summary + reference-column per-job rows (Ticket/Customer/Address/Date/Total/Comm%/TechProfit + expandable payment-method/parts/fees/tip breakdown).
