      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            team management, and business reporting for service
            businesses.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            creating an account. You must notify us immediately
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            transactions are subject to the terms and conditions
            of the applicable payment processor. Processing fees
            may apply.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            claim ownership of your data. You grant UltimatePro a
            limited license to process and store your data solely
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            interfere with the Platform's operation, or to
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            discontinue any feature of the Platform with
            reasonable notice.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            Platform. Our total liability shall not exceed the
            amount you paid for the Platform in the twelve months
            preceding the claim.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            the courts of Virginia Beach, Virginia.
          </p>
        </section>
